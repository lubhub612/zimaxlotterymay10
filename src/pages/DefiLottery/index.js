 ...
 //   handleLottery()
  ...
  const handleApproveZMZ = async () => {
    ...
    try {
      ...
      console.log("🚀 ~ handleApproveZMZ ~ estimateValue", costUSDValue)
...
{lotteryDetails3 ? (
          ...
          {lotteryRound && (
            <div className="round-history">
              <h2>Rounds <span>#{window.web3 ?  lotteryCurrentID : '' }</span>  &nbsp;&nbsp;&nbsp;&nbsp; </h2>
